    ...
    <main>
        ...
        <div class="chart-section u-mt-lg" id="telemetry-section">
            ...
            <div class="period-switcher">
                <a href="?tel_filter=tag&page=1#telemetry-section" class="btn <?= $telemetryFilter === 'tag' ? '' : 'btn-outline' ?>">Heute</a>
                <a href="?tel_filter=letzter_tag&page=1#telemetry-section" class="btn <?= $telemetryFilter === 'letzter_tag' ? '' : 'btn-outline' ?>">Letzter Tag</a>
                <a href="?tel_filter=woche&page=1#telemetry-section" class="btn <?= $telemetryFilter === 'woche' ? '' : 'btn-outline' ?>">Letzte
                    7 Tage</a>
                <a href="?tel_filter=monat&page=1#telemetry-section" class="btn <?= $telemetryFilter === 'monat' ? '' : 'btn-outline' ?>">Letzte
                    30 Tage</a>
            </div>
