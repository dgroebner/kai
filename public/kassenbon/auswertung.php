            ...
            <div class="category-table-container">
                ...
                <table class="category-share-table">
                    ...
                    foreach ($analysis['categories'] as $cat => $data):
                        ...
                        $colorIndex++;
                        ?>
                        <tr class="js-category-row" data-category="<?= htmlspecialchars($cat, ENT_QUOTES, 'UTF-8') ?>"
                            data-percentage="<?= number_format($data['percentage'], 4, '.', '') ?>"
                            data-total="<?= number_format($data['total'], 4, '.', '') ?>" data-color="<?= $color ?>"
                            ...
                            <td class="percentage-cell text-right amount-bold"><?= number_format($data['percentage'], 1, ',', '.') ?>
                                %
                            </td>
