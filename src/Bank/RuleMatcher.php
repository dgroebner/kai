...
class RuleMatcher
{
     ...
     */
    public const string TEXT_FIELD = 'remittance_info';
    public const array PAYEE_FIELDS = ['remitter', 'debitor', 'creditor'];

    /** Spaltenliste für SELECTs auf bank_giro_transactions. */
    private const string TX_COLUMNS = 'id, remittance_info, remitter, debitor, creditor';
